...
You can filter the data by borough as well as channel (app,phone,web). 
Additionally, you can compare by different complaint types.
The slider can be used to looks at different ranges of response times.
When toggled, you can remove extreme outliers by clicking "Cap extreme response times".
